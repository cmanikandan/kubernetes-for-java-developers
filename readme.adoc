...
These instructions are a shorter version of the complete sample code available at https://github.com/aws-samples/kubernetes-for-java-developers by Arun Gupta and others ..
