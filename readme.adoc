...
These steps are a shorter version of the complete sample code and steps available at https://github.com/aws-samples/kubernetes-for-java-developers by Arun Gupta
